 ...
 * @return void
 */
function wp_mock_function($function, $value)
{
    global $wp_mock_functions;
 ...
 *
 * @param  string  $function  Function name
 * @param  mixed  $default  Default value if mock not set
 *
 * @return mixed
 */
function wp_mock_value($function, $default = null)
{
    global $wp_mock_functions;
 ...
 *
 * @param  string|null  $function  Specific function to clear, null for all
 *
 * @return void
 */
function wp_mock_clear($function = null)
{
    global $wp_mock_functions;
